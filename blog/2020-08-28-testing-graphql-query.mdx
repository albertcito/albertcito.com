---
id: testing-laravel-graphql-query
...
If the query to test need authenticacion, you have to add the trail `use WithoutMiddleware;` from `use Illuminate\Foundation\Testing\WithoutMiddleware;`. You may see it working [here](https://github.com/albertcito/laravel-graphql-api/blob/master/tests/Feature/Base/GraphQL/Admin/Query/Tag/TagsQueryTest.php).