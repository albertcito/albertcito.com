---
id: run-private-queries-with-laravel-graphiql
...
Now go to http://127.0.0.1:8000/graphiql/admin and you will be able to see the private area and run any query or mutation. You can see it working with more data in my [github](https://github.com/albertcito/laravel-graphql-api).
