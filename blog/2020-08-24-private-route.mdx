---
slug: private-different-layouts-with-react-router
title: Private and Different Layouts with React Router
tags: [react, react router]
image: https://cdn-images-1.medium.com/max/1600/1*Tp_SStzt1ZLK_wde4d3D3g.gif
---
...
<Image
  ...
  alt="View preview: Private and Different Layouts with React Router"
  title={<>You can see this working <a href="https://albertcito.github.io/templates-react/">live here</a></>}
/>
...
You can download this code in my [Github](https://github.com/albertcito/templates-react/). I updated it, its working with the [API code](https://github.com/albertcito/laravel-graphql-api).