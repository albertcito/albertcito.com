---
id: authentication-laravel-graphql-1
...
This is just a login query. I will post soon how to use it. If you would like to see the code, please go to my [github](https://github.com/albertcito/laravel-graphql-api).